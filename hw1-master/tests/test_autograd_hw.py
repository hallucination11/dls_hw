...
def test_matmul_forward():
    np.testing.assert_allclose(ndl.matmul(ndl.Tensor([[4.95, 1.75, 0.25],
                               ...
                               np.array([[13.7075, 19.5025, 13.26],
    ...
    np.testing.assert_allclose(ndl.matmul(ndl.Tensor([[[4., 2.15],
                                                      ...
                                                      [[0.45, 1.1],
                                                       ...
                                                       [2.9, 1.95]]]), ndl.Tensor([[[2.7, 4.05, 0.1],
                                                                                   ...
                                                                                   [[1.25, 2.1, 0.4],
                                                                                    [0.85, 3.5, 3.7]]])).numpy(),
                               np.array([[[14.5625, 22.7575, 5.345],
                                          [5.7375, 9.18, 3.23],
                                          [4.825, 7.9175, 3.755]],
...
def test_reshape_forward():
    np.testing.assert_allclose(ndl.reshape(ndl.Tensor([[2.9, 2., 2.4],
                                                       ...
                                                       [2.1, 2.5, 2.7],
                                                       [1.9, 4.85, 3.25],
                                                       [3.35, 3.45, 3.45]]), shape=(15,)).numpy(),
                               np.array([2.9, 2., 2.4, 3.95, 3.95, 4.65, 2.1, 2.5, 2.7, 1.9, 4.85,
                                         3.25, 3.35, 3.45, 3.45]))
    np.testing.assert_allclose(ndl.reshape(ndl.Tensor([[[4.1, 4.05, 1.35, 1.65],
                                                       ...
                                                       [[4.7, 1.4, 2.55, 4.8],
                                                        [2.8, 1.75, 2.8, 0.6]],
                                                       [[3.75, 0.6, 0., 3.5],
                                                        [0.15, 1.9, 4.75, 2.8]]]), shape=(2, 3, 4)).numpy(),
                               np.array([[[4.1, 4.05, 1.35, 1.65],
                                          [3.65, 0.9, 0.65, 4.15],
                                          [4.7, 1.4, 2.55, 4.8]],
                                         [[2.8, 1.75, 2.8, 0.6],
                                          [3.75, 0.6, 0., 3.5],
...
def test_transpose_forward():
    ...
    np.testing.assert_allclose(ndl.transpose(ndl.Tensor([[[0.55, 1.8, 0.2],
                                                         ...
                                                         [[0.2, 3.35, 3.4],
                                                          [0.3, 4.85, 4.85],
                                                          [4.35, 4.25, 3.05]]]), axes=(0, 1)).numpy(),
                               np.array([[[0.55, 1.8, 0.2],
                                          [0.75, 1.6, 1.35],
                                          [0.2, 3.35, 3.4]],
                                         [[0.8, 2.75, 3.7],
                                          [3.75, 4., 4.55],
